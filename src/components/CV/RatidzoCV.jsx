      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-base leading-relaxed" style={{ color: "var(--text-muted)" }}>
            Click the button below to download the CV for Ratidzo Fikile Tapera.
          </p>
        </div>
        ...
        >
          ...
          <a
            href="/RatidzoFikileTaperaR238927A.pdf"
            download="RatidzoFikileTaperaR238927A.pdf"
